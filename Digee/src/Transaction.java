...
/*
			...
			//Reciepents address/publickey
			public PublicKey reciepient;
			public float value;
			//This is to prevent any one else spending funds in the wallet
			...
			public boolean processTransaction() {
					...
					if(getInputValue() < Digee.minimumTransaction) {
					...
					//send the value to the receipient
